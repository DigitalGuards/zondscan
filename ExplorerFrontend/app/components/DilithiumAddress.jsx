...
//   React.useEffect(() => {
//     axios.get(config.handlerUrl + '/address/' + pathname.slice(13) + "?page=" + currentPage.toString()).then((response) => {
...
//     });
//     axios.get(config.handlerUrl + "/alltransactions/" + pathname.slice(13)).then((response) => {
...
// export default DilithiumAddress;
