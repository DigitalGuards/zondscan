...
export default function EpochInfoPanel({ epochInfo, loading }: EpochInfoPanelProps) {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-[#2d2d2d] to-[#1f1f1f] rounded-xl border border-[#3d3d3d] p-4 mb-6 animate-pulse">
    ...
    <div className="bg-gradient-to-br from-[#2d2d2d] to-[#1f1f1f] rounded-xl border border-[#3d3d3d] p-4 mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        <div>
          ...
          <p className="text-xl font-semibold text-[#ffa729]">
            {parseInt(epochInfo.headEpoch).toLocaleString()}
          </p>
        </div>
        <div>
          <span className="text-gray-400 text-sm">Current Slot</span>
        ...
        <div>
          <span className="text-gray-400 text-sm">Justified</span>
      ...
      <div className="mt-4">
        ...
        <div className="w-full bg-[#1f1f1f] rounded-full h-2.5 border border-[#3d3d3d]">
          <div
            className="bg-gradient-to-r from-[#ffa729] to-[#ff8c00] h-2.5 rounded-full transition-all duration-1000"
