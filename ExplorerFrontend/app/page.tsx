  ...
  try {
    if (config.handlerUrl) {
      ...
      if (overviewResponse.status === 'fulfilled') {
        ...
        data.marketCap.value = overviewResponse.value.data.marketcap?.toString() || "0";
        data.currentPrice.value = overviewResponse.value.data.currentPrice?.toString() || "0";
        ...
        data.marketCap.error = true;
        data.currentPrice.error = true;
      }
      ...
      data.marketCap.isLoading = false;
      data.currentPrice.isLoading = false;
    }
  } catch (error) {
