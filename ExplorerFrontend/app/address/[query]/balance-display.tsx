  ...
  return (
    <div className="relative overflow-hidden rounded-xl 
      ...
      <div className="flex items-baseline">
        <span className="text-2xl md:text-3xl font-bold text-[#ffa729] break-all">{formattedBalance}</span>
        <span className="ml-2 text-xs md:text-sm text-gray-400">{unit}</span>
      </div>
