...
The network menu identifies QRL Testnet v2 and reserves a disabled entry for future mainnet support. This change preserves the existing address validation and network connections. It contains no 64-byte address migration work.
